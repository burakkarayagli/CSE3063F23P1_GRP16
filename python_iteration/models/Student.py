...
from python_iteration.models.CourseSection import CourseSection
...
class Student(Person):
    ...
    def addCourse(self, course: CourseSection):
        ...
        try:
            ...
            logger.info(f"Course {course.getFullName()} added to waiting list of {self.getFullName()}")
        except:
    ...
    def dropCourse(self, course: CourseSection):
        try:
            ...
            logger.info(f"Course {course.getFullName()} dropped from waiting list of {self.getFullName()}")
        except:
    ...
    def __isCourseInCurrentCoursesList(self, course: CourseSection):
        return self.__isCourseInWaitingCoursesList(course) or self.__isCourseInApprovedCoursesList(course) or self.__isCourseInRejectedCoursesList(course)
    ...
    def __isStudentPassedPrerequisites(self, course: CourseSection):
        ...
        passedCourses_shortNames = [passedCourse.getShortName() for passedCourse in self.__transcript.getPassedCourses()]
    ...
    def getMenu(self):
        MenuString = colored_string(f"Welcome {self.getFullName}", "green") + "\n" + \
            ...
            colored_string("4", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + " List waiting courses\n" + \
            colored_string("5", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + " List approved courses\n" + \
            colored_string("6", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + " List rejected courses\n" + \
...
def getMenu():
        return colored_string(f"Welcome BURAK", "green") + "\n" + \
            ...
            colored_string("3", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + colored_string(" List available courses\n", TEXT_COLOR) + \
            colored_string("4", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + colored_string(" List waiting courses\n", TEXT_COLOR) + \
            colored_string("5", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + colored_string(" List approved courses\n", TEXT_COLOR) + \
            colored_string("6", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + colored_string(" List rejected courses\n", TEXT_COLOR) + \
            colored_string("7", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + colored_string(" List transcript\n", TEXT_COLOR) + \
            colored_string("8", PRIMARY_COLOR) + colored_string("-", SECONDARY_COLOR) + colored_string(" Exit\n", EXIT_COLOR) + \
