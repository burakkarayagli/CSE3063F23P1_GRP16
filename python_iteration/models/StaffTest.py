...
class StaffTest (unittest.TestCase):
    ...
    def test_get_reputation(self):
        staff = Staff("John", "Doe", "johndoe", "password", "Excellent", [], 50000, "Full-time")
    ...
    def test_get_office_hours(self):
        office_hours = [TimeInterval("09:00", "12:00", "Monday"), TimeInterval("14:00", "17:00", "Wednesday")]
        staff = Staff("John", "Doe", "johndoe", "password", "Excellent", office_hours, 50000, "Full-time")
